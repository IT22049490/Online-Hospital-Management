...
<header>
  ...
  <h2>Update your Inquire....</h2>
  
  			Inquiry Id:<br><input type = "text" class="field" name ="inqId" value="<%= id %>" readonly><br>
    
    		Subject:<br><input type = "text" class="field" name ="subject" value="<%= subject%>"><br>
    		Date:<br><input type = "text" class="field" name ="date" value="<%= date%>"><br>
    		
    		<label for="message">Inquiry Message:</label><br>
    		
			<textarea id="message" class="field" name="message"   rows="4" cols="50"><%= message%></textarea><br>
			
			<input type = "submit" class="updatebutton" name= "submit" value="Update My Data"> <br>
