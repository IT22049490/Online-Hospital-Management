...
<%
		...
		String Details = request.getParameter("MDetails");
	%>
    <div class="container">
        <h2>Update Profile</h2>
        <form id="registration-form" action="update1" method="post">
            ...
            <div class="form-group">
                ...
                <input type="tel" id="phone" name="phone"  value="<%=number%>"required>
            </div>
            <div class="form-group">
